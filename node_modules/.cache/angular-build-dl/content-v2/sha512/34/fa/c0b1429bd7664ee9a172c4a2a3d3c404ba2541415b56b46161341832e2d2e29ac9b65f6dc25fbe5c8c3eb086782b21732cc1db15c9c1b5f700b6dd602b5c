...
const routes = [
    ...
    { path: 'dashboard', component: _pages_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_2__["DashboardComponent"], children: [
            ...
            { path: 'cliam-summary', component: _claim_cliam_summary_cliam_summary_component__WEBPACK_IMPORTED_MODULE_8__["CliamSummaryComponent"] }
        ] },
];
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _claim_cliam_create_cliam_create_component__WEBPACK_IMPORTED_MODULE_46__["CliamCreateComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_18__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_18__["ReactiveFormsModule"],
        ngx_smart_popover__WEBPACK_IMPORTED_MODULE_23__["PopoverModule"],
...
CreateContractComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: CreateContractComponent, selectors: [["app-create-contract"]], decls: 133, vars: 1, consts: [[1, "modal-dialog", "modal-xl"], [1, "modal-content"], [1, "modal-header"], ["type", "button", "data-dismiss", "modal", "aria-hidden", "true", 1, "close"], ["id", "myModalLabel", 1, "modal-title", "text-center"], [1, "modal-body"], [1, "form-horizontal", 3, "formGroup"], [1, "form-group", "row", "request-types"], [1, "col-md-6", "requestType"], ["for", "username"], [1, "text-danger"], ["formControlName", "ContractAffiliate", "placeholder", "Common area maintenance", 1, "form-control"], [1, "col-md-3"], ["for", "emailaddress"], [1, "col-3"], ["type", "text", "formControlName", "ContractAffiliate", "id", "date-ticket", "name", "date-ticket", 1, "form-control"], [1, "form-group", "row", "mb-0"], [1, "col-3", "form-group", "date-picker"], [1, "input-group"], ["type", "text", "id", "date-ticket", "formControlName", "ContractAffiliate", "name", "Contract-Name"], [1, "col-3", "requestType"], ["formControlName", "ContractAffiliate", "placeholder", "Renewal Type", 1, "form-control"], ["type", "date", "id", "date-ticket", "name", "date-ticket", 1, "form-control"], ["type", "date", "formControlName", "ContractAffiliate", "id", "date-ticket", "name", "date-ticket", 1, "form-control"], ["type", "date", "id", "date-ticket", "formControlName", "ContractAffiliate", "name", "Contract-Name"], [1, "col-3", "requestType", "mt-4"], [1, "custom-control", "custom-checkbox"], ["type", "checkbox", "formControlName", "ContractAffiliate", "id", "customCheck1", 1, "custom-control-input"], ["for", "customCheck1", 1, "custom-control-label"], [1, "card-box"], [1, "header-title", "mb-4"], [1, "col-6"], [1, "col-6", "requestType"], [1, "mb-2"], ["type", "checkbox", "id", "customCheck77", 1, "custom-control-input"], ["for", "customCheck77", 1, "custom-control-label"], ["type", "checkbox", "id", "customCheck2", 1, "custom-control-input"], ["for", "customCheck2", 1, "custom-control-label"], ["type", "checkbox", "id", "customCheck3", 1, "custom-control-input"], ["for", "customCheck3", 1, "custom-control-label"], [1, "row", "mb-2"], [1, "col-md-6"], [1, "header-title", "pt-1"], [1, "col-md-6", "text-right"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-warning", "mr-2"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-orange", "mr-2", 3, "click"], ["type", "button", "data-dismiss", "modal", 1, "btn", "btn-secondary"]], template: function CreateContractComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateContractComponent_Template_button_click_129_listener() { return ctx.add(); });
